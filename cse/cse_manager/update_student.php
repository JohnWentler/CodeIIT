...
?>
    ...
    <div class= "student">
        <div class="row">
            ...
            echo "<table id = 'table_id' class='table table-striped table-bordered table-sm table-hover table-responsive' cellspacing='0' style= 'width:100%'>
            <thead>
            <tr>
                <th> Id </th>
                <th> Name </th>
            ...
            if($check_faculty)
            {
                ...
                while($row= mysqli_fetch_assoc($query_run))
                {
                    ...
                    echo "<td><a href='edit_student?id=" .$row['id']."'> Edit </a></td>";
                    echo "<td><a href='delete_student?id=" .$row['id']."'> Delete </a></td>";
                    echo "</tr>";
                }
                echo "<tbody>";
                echo "</table>";
    ...
    <div class = "extrabtn">
        <div class = 'wrapper'>
            <button class='button'> <a href = 'student_input'> Add new Student </a></button>
        </div>
    </div>
