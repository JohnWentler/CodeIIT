...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2023 at 10:12 AM
...
('Lucas', 'Assistant Professor ', 'lucas@iitgn.ac.in', ' ', '', ' ', 'RavirajSukhadiya.jpg', 0),
...
(0, 'Lucas', '', 'Lucas is not current Director of the Indian Institute of Technology Gandhinagar (IITGN).  ', '2023-07', ' ', ' '),
...
INSERT INTO `staff_details` (`id`, `staff_Name`, `about`, `email_id`, `personal_link`, `staff_image`) VALUES
(1, 'Kelly Shelby', 'Hi Everyone, I\'m Kelly Shelby Now I\'m Student and I completed study BTech in 2049. In my features Plan is I want to join in NASA Space Mission.', 'kelly@saera211gmail.com', '  https://bard.google.com/', 'Profile.png'),
(2, 'Raviraj Sukhadiya', 'Raviraj Sukhadiya - I am working in Computer Science & Engineering Lab at IIT Gandhinagar, where I am reported by Prof. Anirban Dasgupta. My interests lie in Website and Application Development. Specifically, I am interested in Android Application Development.', 'raviraj.s@iitgn.ac.in', 'https://ravirajsukhadiya.github.io/', 'RavirajSukhadiya.jpg');
